  ...
  describe('Async Structures and Functions in Scripts', function () {
    ...
    it('should handle promise properties at different levels in script', async () => {
      ...
      const script = `
          ...
          result.val2 = complex.nested.l2
          result.val3 = complex.nested.deep[0]
    ...
    describe('Lazy Deep Resolve: setPath Consistency', () => {
      ...
      it('should verify Async Value assignment allows immediate property access (Lazy Object)', async () => {
        ...
        const script = `
          ...
          result.assignmentTime = t1 - t0
          result.accessTime = t2 - t1
          result.val = val
          result.y = obj.y
