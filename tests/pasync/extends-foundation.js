...
describe('Extends Foundation', function () {
  ...
  describe('Phase 3 - Method Metadata Compilation', function () {
    ...
    it('should expose compiled methods metadata up front', function () {
      ...
      expect(script.inheritanceSpec.methodEntries).to.be.ok();
      expect(script.inheritanceSpec.methodEntries.build).to.be.ok();
      expect(typeof script.inheritanceSpec.methodEntries.build.fn).to.be('function');
      expect(script.inheritanceSpec.methodEntries.build.ownMutatedChannels).to.be.an(Array);
    ...
    it('should record shared-root channel usage in compiled method metadata', function () {
      ...
      expect(script.inheritanceSpec.methodEntries.build.ownMutatedChannels).to.contain('trace');
      expect(script.inheritanceSpec.methodEntries.build.ownMutatedChannels).not.to.contain('theme');
      expect(script.inheritanceSpec.methodEntries.build.ownLinkedChannels).to.contain('theme');
      expect(script.inheritanceSpec.methodEntries.build.ownLinkedChannels).to.contain('trace');
    });
    ...
    it('should expose __constructor__ in the compiled methods map with internal metadata', function () {
      ...
      expect(script.inheritanceSpec.methodEntries).to.be.ok();
      expect(script.inheritanceSpec.methodEntries.__constructor__).to.be.ok();
      expect(typeof script.inheritanceSpec.methodEntries.__constructor__.fn).to.be('function');
      expect(script.inheritanceSpec.methodEntries.__constructor__.ownMutatedChannels).to.be.an(Array);
      expect(script.inheritanceSpec.methodEntries.__constructor__.ownLinkedChannels).to.be.an(Array);
      expect(script.inheritanceSpec.methodEntries.__constructor__.ownMutatedChannels).to.contain('trace');
    ...
    it('should omit __constructor__ from the compiled methods map when there is no constructor body', function () {
      ...
      expect(script.inheritanceSpec.methodEntries).to.be.ok();
      expect(Object.prototype.hasOwnProperty.call(script.inheritanceSpec.methodEntries, '__constructor__')).to.be(false);
    });
  ...
  describe.skip('Phase 4 - Method and Shared Startup Registration', function () {
    it('should record inherited method references as invoked-method metadata without placeholders', function () {
      ...
      expect(script.inheritanceSpec.methodEntries.lookup).to.be(undefined);
      expect(script.inheritanceSpec.invokedMethodRefs.lookup.name).to.be('lookup');
      expect(script.inheritanceSpec.methodEntries.build.invokedMethodRefs.lookup.name).to.be('lookup');
    });
    ...
    it('should create inheritance state in the root body before bootstrapping metadata', function () {
      ...
      expect(source).to.contain('inheritanceState = runtime.bootstrapInheritanceMetadata(inheritanceState, __compiledMethodEntries, __compiledSharedSchema, ');
      expect(source).to.contain('__compiledMethodEntries, __compiledSharedSchema, ');
    ...
    it('should preserve the child method entry and wire parent super metadata when parent methods register later', function () {
      ...
      expect(childScript.inheritanceSpec.methodEntries.build.super).to.be(true);

      const inheritanceState = runtime.createInheritanceState();
      runtime.bootstrapInheritanceMetadata(inheritanceState, childScript.inheritanceSpec.methodEntries, childScript.inheritanceSpec.sharedSchema, childScript.inheritanceSpec.invokedMethodRefs);
      runtime.bootstrapInheritanceMetadata(inheritanceState, parentScript.inheritanceSpec.methodEntries, parentScript.inheritanceSpec.sharedSchema, parentScript.inheritanceSpec.invokedMethodRefs);

      expect(inheritanceState.methods.build).not.to.be(childScript.inheritanceSpec.methodEntries.build);
      expect(inheritanceState.methods.build.fn).to.be(childScript.inheritanceSpec.methodEntries.build.fn);
      expect(inheritanceState.methods.build.ownerKey).to.be('C.script');
      expect(inheritanceState.methods.build.super).not.to.be(childScript.inheritanceSpec.methodEntries.build.super);
      expect(inheritanceState.methods.build.super.fn).to.be(parentScript.inheritanceSpec.methodEntries.build.fn);
    ...
    it('should wire multi-level super chains as each ancestor registers later', function () {
      ...
      expect(childScript.inheritanceSpec.methodEntries.build.super).to.be(true);
      expect(parentScript.inheritanceSpec.methodEntries.build.super).to.be(true);

      const inheritanceState = runtime.createInheritanceState();
      runtime.bootstrapInheritanceMetadata(inheritanceState, childScript.inheritanceSpec.methodEntries, childScript.inheritanceSpec.sharedSchema, childScript.inheritanceSpec.invokedMethodRefs);
      runtime.bootstrapInheritanceMetadata(inheritanceState, parentScript.inheritanceSpec.methodEntries, parentScript.inheritanceSpec.sharedSchema, parentScript.inheritanceSpec.invokedMethodRefs);
      runtime.bootstrapInheritanceMetadata(inheritanceState, grandparentScript.inheritanceSpec.methodEntries, grandparentScript.inheritanceSpec.sharedSchema, grandparentScript.inheritanceSpec.invokedMethodRefs);

      expect(inheritanceState.methods.build).not.to.be(childScript.inheritanceSpec.methodEntries.build);
      expect(inheritanceState.methods.build.fn).to.be(childScript.inheritanceSpec.methodEntries.build.fn);
      expect(inheritanceState.methods.build.super.fn).to.be(parentScript.inheritanceSpec.methodEntries.build.fn);
      expect(inheritanceState.methods.build.super.super.fn).to.be(grandparentScript.inheritanceSpec.methodEntries.build.fn);
    ...
    it('should reject missing invoked-method metadata at the topmost root', function () {
      ...
      expect(script.inheritanceSpec.methodEntries.build).to.be(undefined);
      expect(script.inheritanceSpec.invokedMethodRefs.build.name).to.be('build');

      const inheritanceState = runtime.createInheritanceState();
      runtime.bootstrapInheritanceMetadata(
        inheritanceState,
        script.inheritanceSpec.methodEntries,
        script.inheritanceSpec.sharedSchema,
        script.inheritanceSpec.invokedMethodRefs,
        null,
    ...
    it('should resolve file-level and per-callable invoked method metadata during finalization', function () {
      ...
      expect(childScript.inheritanceSpec.invokedMethodRefs.render.name).to.be('render');
      expect(childScript.inheritanceSpec.invokedMethodRefs.decorate.name).to.be('decorate');
      expect(childScript.inheritanceSpec.invokedMethodRefs.build.name).to.be('build');
      expect(childScript.inheritanceSpec.methodEntries.build.invokedMethodRefs.render.name).to.be('render');
      expect(childScript.inheritanceSpec.methodEntries.build.invokedMethodRefs.decorate.name).to.be('decorate');
      expect(childScript.inheritanceSpec.methodEntries.build.invokedMethodRefs.render.origin.path).to.be('C.script');
      expect(Object.keys(childScript.inheritanceSpec.methodEntries.decorate.invokedMethodRefs)).to.eql([]);

      const inheritanceState = runtime.createInheritanceState();
      runtime.bootstrapInheritanceMetadata(
        inheritanceState,
        childScript.inheritanceSpec.methodEntries,
        childScript.inheritanceSpec.sharedSchema,
        childScript.inheritanceSpec.invokedMethodRefs,
        null,
        { path: 'C.script' }
      );
      runtime.bootstrapInheritanceMetadata(
        inheritanceState,
        parentScript.inheritanceSpec.methodEntries,
        parentScript.inheritanceSpec.sharedSchema,
        parentScript.inheritanceSpec.invokedMethodRefs,
        null,
        { path: 'A.script' }
      );
      runtime.finalizeInheritanceMetadata(inheritanceState, { path: 'C.script' });

      expect(Object.keys(inheritanceState.invokedMethodRefs)).to.eql([]);
      ...
      expect(buildData.invokedMethodRefs).to.be(undefined);
      expect(buildData.ownMutatedChannels).to.be(undefined);
      expect(buildData.ownLinkedChannels).to.be(undefined);
      expect(inheritanceCallModule.getMethodData(inheritanceState, 'decorate').invokedMethodRefs).to.be(undefined);
    ...
    it('should resolve cyclic invoked method metadata without recursive expansion', function () {
      ...
      expect(Object.keys(inheritanceState.invokedMethodRefs)).to.eql([]);
      expect(alphaData.invokedMethodRefs).to.be(undefined);
      expect(betaData.invokedMethodRefs).to.be(undefined);
    ...
    it('should keep per-callable invoked method metadata limited to direct calls', function () {
      ...
      expect(script.inheritanceSpec.invokedMethodRefs.hidden.name).to.be('hidden');
      expect(script.inheritanceSpec.invokedMethodRefs.visible.name).to.be('visible');
      expect(script.inheritanceSpec.methodEntries.build.invokedMethodRefs.visible.name).to.be('visible');
      expect(script.inheritanceSpec.methodEntries.build.invokedMethodRefs.hidden).to.be(undefined);
    });
    ...
    it('should reject unresolved super metadata at the topmost root', function () {
      ...
      const inheritanceState = runtime.createInheritanceState();
      runtime.bootstrapInheritanceMetadata(inheritanceState, script.inheritanceSpec.methodEntries, script.inheritanceSpec.sharedSchema, script.inheritanceSpec.invokedMethodRefs);
    ...
    it('should reject conflicting shared channel types across the inheritance chain', function () {
      ...
      try {
        runtime.bootstrapInheritanceMetadata(inheritanceState, parentScript.inheritanceSpec.methodEntries, parentScript.inheritanceSpec.sharedSchema, parentScript.inheritanceSpec.invokedMethodRefs, null, { path: 'A.script' });
    ...
    it('should not rebuild finalized invoked-method metadata on repeated finalization', function () {
      ...
      const compiledMethodEntries = {
        build: {
          ...
          ownLinkedChannels: [],
          super: false,
          invokedMethodRefs: { helper: 'helper' }
        },
        helper: {
          fn() {
            return 'helper';
  ...
  describe.skip('Phase 6 - Helper and Resolution Lifecycle', function () {
    ...
    it('should keep repeated bootstrap of the same owner idempotent', function () {
      ...
      const state = runtime.createInheritanceState();
      runtime.bootstrapInheritanceMetadata(state, script.inheritanceSpec.methodEntries, script.inheritanceSpec.sharedSchema, script.inheritanceSpec.invokedMethodRefs);
      runtime.bootstrapInheritanceMetadata(state, script.inheritanceSpec.methodEntries, script.inheritanceSpec.sharedSchema, script.inheritanceSpec.invokedMethodRefs);
