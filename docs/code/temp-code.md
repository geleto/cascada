...
- `OutputHandler` class (snapshot support)
  - **Where**: `src/runtime/frame.js`, exported in `src/runtime/runtime.js`
...
- `OutputHandler._snapshotFocus(focusName)`
  - **Where**: `src/runtime/frame.js`
