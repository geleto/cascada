function installCompat() {
  ...
  var orig_contextOrSyncFrameVarLookup = runtime.contextOrSyncFrameVarLookup;
  ...
  function uninstall() {
    runtime.contextOrSyncFrameVarLookup = orig_contextOrSyncFrameVarLookup;
  ...
  runtime.contextOrSyncFrameVarLookup = function contextOrSyncFrameVarLookup(context, frame, key) {
    var val = orig_contextOrSyncFrameVarLookup.apply(this, arguments);
    if (val !== undefined) {
      return val;
    }
    switch (key) {
