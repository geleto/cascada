...
module.exports = {
  ...
  StartComponentInstanceCommand: componentRuntime.StartComponentInstanceCommand,
  ...
  mergeInheritanceStartupPromise: inheritanceState.mergeInheritanceStartupPromise,
  beginInheritanceMetadataReadiness: inheritanceState.beginInheritanceMetadataReadiness,
  resolveInheritanceMetadataReadiness: inheritanceState.resolveInheritanceMetadataReadiness,
  rejectInheritanceMetadataReadiness: inheritanceState.rejectInheritanceMetadataReadiness,
  awaitInheritanceMetadataReadiness: inheritanceState.awaitInheritanceMetadataReadiness,
  consumeInheritanceMetadataReadyYield: inheritanceState.consumeInheritanceMetadataReadyYield,
  setInheritanceCompositionMode: inheritanceState.setInheritanceCompositionMode,
  isInheritanceCompositionMode: inheritanceState.isInheritanceCompositionMode,
  enterInheritanceChainPath: inheritanceState.enterInheritanceChainPath,
  leaveInheritanceChainPath: inheritanceState.leaveInheritanceChainPath,
  isUnresolvedSuperEntry: inheritanceState.isUnresolvedSuperEntry,
  ...
  getMethodData: inheritanceCall.getMethodData,
  mergeUniqueChannelNames: inheritanceCall.mergeUniqueChannelNames,
  getMethodLinkedChannels: inheritanceCall.getMethodLinkedChannels,
