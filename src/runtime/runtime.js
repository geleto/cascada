...
module.exports = {
  ...
  createExtendsCompositionPayload: inheritanceState.createExtendsCompositionPayload,
  createInheritancePayload: inheritanceState.createInheritancePayload,
  prepareBlockEntryContext: inheritanceState.prepareBlockEntryContext,
  ...
  getExtendsComposition: inheritanceState.getExtendsComposition,
  ...
  prepareInheritancePayloadForBlock: inheritanceState.prepareInheritancePayloadForBlock,
  ...
  createSuperInheritancePayload: inheritanceState.createSuperInheritancePayload,
  ...
  setExtendsComposition: inheritanceState.setExtendsComposition,
  setTemplateLocalCaptures: inheritanceState.setTemplateLocalCaptures,
