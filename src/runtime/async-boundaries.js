...
function _createChildBoundary(parentBuffer, boundaryLinkedChainNames, boundaryLinkedMutatedChainNames = null, isolatedContext = null, bufferStackErrorContext, traceParent = null, renderState = null) {
  ...
  const childBuffer = new CommandBuffer(
    bufferContext,
    null,
    boundaryLinkedChainNames,
    parentBuffer || null,
    boundaryLinkedMutatedChainNames,
 ...
 */
function runControlFlowBoundary(parentBuffer, boundaryLinkedChainNames, boundaryLinkedMutatedChainNames, context, renderState, boundaryFn, bufferStackErrorContext) {
  renderState.throwIfFatalErrorReported();
  const childBuffer = _createChildBoundary(parentBuffer, boundaryLinkedChainNames, boundaryLinkedMutatedChainNames, null, bufferStackErrorContext, null, renderState);
 ...
 */
function runWaitedControlFlowBoundary(parentBuffer, boundaryLinkedChainNames, boundaryLinkedMutatedChainNames, context, renderState, boundaryFn, waitedChainName, bufferStackErrorContext) {
  renderState.throwIfFatalErrorReported();
  const childBuffer = _createChildBoundary(parentBuffer, boundaryLinkedChainNames, boundaryLinkedMutatedChainNames, null, bufferStackErrorContext, null, renderState);
 ...
 */
function runValueBoundary(parentBuffer, boundaryLinkedChainNames, boundaryLinkedMutatedChainNames, boundaryFn, bufferStackErrorContext) {
  const childBuffer = _createChildBoundary(parentBuffer, boundaryLinkedChainNames, boundaryLinkedMutatedChainNames, null, bufferStackErrorContext);
  let result;
  try {
    result = boundaryFn(childBuffer);
  } catch (err) {
